...
import { ETH_COIN_TYPE, Node, PluginName } from "@ensnode/utils";
...
/**
 * Makes an additional set of handlers for Resolver events that track the emitted record values.
 */
export const makeResolverRecordHandlers = ({ pluginName }: { pluginName: PluginName }) => {
  return {
