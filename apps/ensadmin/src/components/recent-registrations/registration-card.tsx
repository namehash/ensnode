...
export function RegistrationCard({registration, namespaceId}: RegistrationCardProps) {
    return <div
        className="w-full min-h-[80px] box-border flex flex-row max-lg:flex-wrap flex-nowrap justify-between items-center max-lg:gap-3 rounded-xl border p-3 text-sm">
...
({elementName, className, children}: PropsWithChildren<RegistrationCardElementProps>) =>
