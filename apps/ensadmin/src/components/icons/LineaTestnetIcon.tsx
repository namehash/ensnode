...
(
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <g clipPath="url(#clip0_75_253)">
            ...
            <mask id="mask0_75_253" style="mask-type:luminance" maskUnits="userSpaceOnUse" x="5" y="5" width="11"
                  height="10">
                <path d="M15.1779 5.00134H5.72156V14.9991H15.1779V5.00134Z" fill="white"/>
            </mask>
            <g mask="url(#mask0_75_253)">
                <path d="M13.5751 14.9991H5.72156V6.62366H7.51845V13.3759H13.5751V14.9982V14.9991Z" fill="#121212"/>
                <path
