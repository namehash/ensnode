...
export default function NameNavigationPage(){
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Seems legit if this requirement: "For now, there will be no validation or transformations
                ...
                <CardContent>
                    ...
                    <form className="flex flex-col gap-2" onSubmit={handleSubmit}>
                        <fieldset className="flex flex-row gap-2 justify-start items-center">
                            ...
                            />
                            <Button type="submit" disabled={searchedName.length === 0}>View Name</Button>
                        </fieldset>
                    </form>
                </CardContent>
            </Card>
