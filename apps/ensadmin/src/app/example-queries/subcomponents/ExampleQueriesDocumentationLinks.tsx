...
export default function ExampleQueriesDocumentationLinks(
  props: ExampleQueriesDocumentationLinksProps,
) {
  return (
    <div className={cn("flex flex-row items-center justify-center gap-4", props.styles)}>
