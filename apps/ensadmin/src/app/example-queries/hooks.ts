    ...
    const snippets = useMemo(
        () =>
            [    {
                ...
                longDescription: "More detailed description of the query that could be cut after some number of characters and displayed fully in a tooltip or something",
                icon: Lightbulb,
  ...
  domains(first: 1, where: {name: $name}) {
    ...
    `,
                ...
                },
                {
                    ...
                    longDescription: "Get the first 20 names owned by address `0xb8c2C29ee19D8307cb7255e1Cd9CbDE883A267d5` ordered by name ascending",
                    icon: GraduationCap,
