...
| `texts.email`                                     | ✅     | [18](https://docs.ens.domains/ensip/18), [5](https://docs.ens.domains/ensip/5)   | Contact email address. GraphQL: `profile.email`. Parser: `ProfileEmailParser`.                                                                                                        |
...
| `texts.vnd.twitter`                               | ✅     | [5](https://docs.ens.domains/ensip/5)                                            | Legacy Twitter key (renamed to `com.twitter`). Fallback when `com.twitter` is unset. Parser: `SocialTwitterParser`.                                                                   |
