...
AccountRef.implement({
  ...
  fields: (t) => ({
    ...
    nameReferences: t.connection({
      description:
        "The Names whose indexed `addr()` record points at this Account, optionally scoped to a single CoinType. Reflects literally-indexed, canonical Domains only: records whose node has no canonical Domain are omitted, and Forward Resolution / CCIP-Read and ENSIP-19 default-address-record expansion are not applied.",
