...
DomainInterfaceRef.implement({
  ...
  fields: (t) => ({
    ...
    owner: t.field({
      type: AccountRef,
      description:
        "If this is an ENSv1Domain, this is the effective owner of the Domain. If this is an ENSv2Domain, this is the HCA account address if used, otherwise Transaction.from.",
      nullable: true,
