...
Commits to `main` automatically publish prerelease versions with the `next` dist-tag to NPM. These allow testing of changes before an official release.
...
**Important notes:**
- Preview versions are ephemeral and don't create commits or modify the repository
