...
<LinkCard
  ...
  href="https://github.com/namehash/ensnode/blob/main/docker/docker-compose.yml"
  target="_blank"
/>
:::
...
For more compose files (devnet, CI), configuration options, and all available commands, see the [Deploying with Docker](/ensnode/deploying/docker) guide and [`docker/README.md`](https://github.com/namehash/ensnode/blob/main/docker/README.md).
