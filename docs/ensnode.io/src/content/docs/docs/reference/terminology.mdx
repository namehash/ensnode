...
A `subgraph-unindexable` Label is either:
  - an **Unknown Label**, or
  - a **Literal Label** that contains any of the prohibited UTF-8 characters.

A `subgraph-indexable` Label is a **Known Literal Label** that does NOT contain any of the prohibited UTF-8 characters.
