...
<LinkCard title="Local Development" href="/docs/components/ensrainbow/contributing/local-development" />
<LinkCard title="Creating ENSRainbow Files" href="/docs/components/ensrainbow/concepts/creating-files" />
<LinkCard title="CLI Reference" href="/docs/components/ensrainbow/contributing/cli-reference" />
<LinkCard title="Service Management" href="/docs/components/ensrainbow/contributing/service-management" />
<LinkCard title="System Requirements" href="/docs/components/ensrainbow/contributing/system-requirements" />
<LinkCard title="Building Docker Images" href="/docs/components/ensrainbow/contributing/building" />

:::tip[Choose Your Path]
- **New to the project?** Start with [Local Development](/docs/components/ensrainbow/contributing/local-development)
- **Creating custom datasets?** See [Creating ENSRainbow Files](/docs/components/ensrainbow/concepts/creating-files)
- **Need CLI help?** Check the [CLI Reference](/docs/components/ensrainbow/contributing/cli-reference)
- **Building for production?** See [Building Docker Images](/docs/components/ensrainbow/contributing/building)
:::
...
1. **Follow ENSNode's [contribution guide](/docs/reference/contributing)** to prepare your workspace environment & install dependencies
2. **Choose your development path** using the focused guides above
3. **Start with [Local Development](/docs/components/ensrainbow/contributing/local-development/)** for the quickest way to get ENSRainbow running locally

## Quick Reference

- **Need to build from source?** → [Building Docker Images](/docs/components/ensrainbow/contributing/building)
- **Creating custom datasets?** → [Creating ENSRainbow Files](/docs/components/ensrainbow/concepts/creating-files)
- **Looking for CLI commands?** → [CLI Reference](/docs/components/ensrainbow/contributing/cli-reference)
- **Running into issues?** → [Troubleshooting](/docs/components/ensrainbow/usage/troubleshooting)
- **Want to understand the data flow?** → [Data Model](/docs/components/ensrainbow/concepts/data-model)
...
- **`LABEL_SET_ID`**: See **[Label Set ID](/docs/components/ensrainbow/concepts/glossary#label-set-id)**.
  - **Goal**: To enable the extensible definition of new label sets (e.g., subgraph vs. production vs. test).
  - **Configuration**: See the [Available Label Sets](/docs/components/ensrainbow/usage/available-label-sets) page for a complete list of currently available label set IDs and their descriptions.

- **`LABEL_SET_VERSION`**: See **[Label Set Version](/docs/components/ensrainbow/concepts/glossary#label-set-version)**.
...
This section covers the conversion of source data (like CSV data or empty files for initial datasets) into the `.ensrainbow` format. For detailed conversion instructions and examples, see the [Creating ENSRainbow Files](/docs/components/ensrainbow/concepts/creating-files) guide.
