...
The ENSRainbow storage needed for a set of rainbow tables for healing unknown labels ranges from 1 MB to dozens of GB depending on the label set ID and label set version. See [System Requirements](/docs/components/ensrainbow/contributing/system-requirements/) for details.
:::
...
See the [Configuration](/docs/components/ensrainbow/usage/configuration/) page for detailed descriptions of all environment variables and configuration options.
:::
