...
For detailed information about the file format structure, see the [Data Model](/docs/components/ensrainbow/concepts/data-model) documentation.
...
1. **[Ingest the data](/docs/components/ensrainbow/contributing/index#data-ingestion-ingest-ensrainbow)** into a ENSRainbow database
2. **[Validate the database](/docs/components/ensrainbow/contributing/index#database-validation-validate)** to ensure integrity
3. **[Start the API server](/docs/components/ensrainbow/contributing/index#api-server-serve)** to serve the data

For complete CLI reference information, see the [CLI Reference](/docs/components/ensrainbow/contributing/cli-reference) documentation.
...
If you want to run your own ENSRainbow API server (separate from the label set server), see the [Local Development](/docs/components/ensrainbow/contributing/local-development) guide for instructions on setting up and running ENSRainbow locally or in production.

## Related Documentation

- **[Data Model](/docs/components/ensrainbow/concepts/data-model)** - Understanding the `.ensrainbow` file format
- **[Label Sets & Versioning](/docs/components/ensrainbow/concepts/label-sets-and-versioning)** - Managing label set versions
- **[CLI Reference](/docs/components/ensrainbow/contributing/cli-reference)** - Complete command documentation
- **[Local Development](/docs/components/ensrainbow/contributing/local-development)** - Setting up your development environment
