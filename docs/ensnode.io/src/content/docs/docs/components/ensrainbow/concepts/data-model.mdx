...
A [rainbow record](/docs/components/ensrainbow/concepts/glossary#rainbow-record) with versioning information:
...
```protobuf
// Protobuf serialization format for [rainbow records](/docs/components/ensrainbow/concepts/glossary#rainbow-record)
...
For complete instructions, examples, and workflow guidance, see the [Creating ENSRainbow Files](/docs/components/ensrainbow/concepts/creating-files) guide.
...
- **[Glossary](/docs/components/ensrainbow/concepts/glossary)** - Key terms like [System Key](/docs/components/ensrainbow/concepts/glossary#system-key), [Ingestion](/docs/components/ensrainbow/concepts/glossary#ingestion), etc.
- **[Label Sets & Versioning](/docs/components/ensrainbow/concepts/label-sets-and-versioning)** - Understanding the versioning system
- **[TypeScript Interfaces](/docs/components/ensrainbow/concepts/typescript-interfaces)** - Type definitions for working with the data 
