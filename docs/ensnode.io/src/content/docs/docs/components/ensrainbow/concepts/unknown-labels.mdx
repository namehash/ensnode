...
An **Unknown Label** is a [**Label**](/docs/components/ensrainbow/concepts/glossary#label) that is known to exist, but where only the [**LabelHash**](/docs/components/ensrainbow/concepts/glossary#labelhash) of the label is known, not the human-readable string. These unknown labels are represented by ENS indexers as encoded labelhashes using the format `[{LabelHash}]`.
...
- **[Rainbow table](/docs/components/ensrainbow/concepts/glossary#rainbow-table) lookups**: The human-readable label for a given labelhash can be determined via customizable and massive rainbow table lookups through ENSRainbow
...
The [**labelhash**](/docs/components/ensrainbow/concepts/glossary#labelhash) function computes a 32-byte hash of a label using `keccak256`:
...
- For deterministic indexing results across time, pin healing to a specific label set ID + version (see [Label Sets & Versioning](/docs/components/ensrainbow/concepts/label-sets-and-versioning))
...
ENSRainbow mitigates the unknown labels problem by providing a **[healing](/docs/components/ensrainbow/concepts/glossary#heal) service** that converts labelhashes back to human-readable labels via [rainbow table](/docs/components/ensrainbow/concepts/glossary#rainbow-table) lookups.

### What is Healing?

[**Healing**](/docs/components/ensrainbow/concepts/glossary#heal) is the act of converting a labelhash back to its original label via a rainbow table lookup or other special strategies implemented in ENSNode. ENSRainbow maintains pre-computed mappings of `labelhash → label` pairs (called [rainbow records](/docs/components/ensrainbow/concepts/glossary#rainbow-record)) that enable this reverse lookup.

### How ENSRainbow Works

ENSRainbow operates as a **sidecar service** to ENSNode:

1. **[Rainbow Table](/docs/components/ensrainbow/concepts/glossary#rainbow-table) Storage**: ENSRainbow maintains LevelDB databases containing millions of labelhash-to-label mappings
...
- **Multiple label sets**: Different [label sets](/docs/components/ensrainbow/concepts/glossary#label-set) (identified by [label set ID](/docs/components/ensrainbow/concepts/glossary#label-set-id)) can provide different coverage, allowing the ecosystem to contribute additional healing data

### Label Sets and Versioning

ENSRainbow uses a [**label set**](/docs/components/ensrainbow/concepts/glossary#label-set) system to organize rainbow table data:

- **[Label Set ID](/docs/components/ensrainbow/concepts/glossary#label-set-id)**: Identifies a collection of [rainbow records](/docs/components/ensrainbow/concepts/glossary#rainbow-record) (e.g., `subgraph`, `discovery-a`)
- **[Label Set Version](/docs/components/ensrainbow/concepts/glossary#label-set-version)**: Monotonically increasing version numbers that enable incremental updates
...
For more details, see [Label Sets & Versioning](/docs/components/ensrainbow/concepts/label-sets-and-versioning).

## Related Documentation

- **[Glossary](/docs/components/ensrainbow/concepts/glossary)** - Key terminology including [labelhash](/docs/components/ensrainbow/concepts/glossary#labelhash), [heal](/docs/components/ensrainbow/concepts/glossary#heal), and [rainbow table](/docs/components/ensrainbow/concepts/glossary#rainbow-table)
- **[Label Sets & Versioning](/docs/components/ensrainbow/concepts/label-sets-and-versioning)** - Understanding how ENSRainbow organizes healing data
- **[Architecture](/docs/components/ensrainbow/concepts/architecture)** - High-level system architecture and data flow
- **[API Reference](/docs/components/ensrainbow/usage/api)** - Complete HTTP API documentation for ENSRainbow
