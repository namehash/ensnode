...
ENSRainbow's TypeScript APIs expose two companion interfaces that describe **which [label sets](/docs/components/ensrainbow/concepts/glossary#label-set)** **are available (server-side) or requested (client-side)**.
...
- **`labelSetId`** identifies **which [label set](/docs/components/ensrainbow/concepts/glossary#label-set)** the server is currently serving.
...
- **[Client SDK](/docs/components/ensrainbow/usage/client-sdk/)** - How to use these interfaces in practice
- **[API Reference](/docs/components/ensrainbow/usage/api/)** - HTTP API endpoints that return these types
- **[Label Sets & Versioning](/docs/components/ensrainbow/concepts/label-sets-and-versioning)** - Understanding the versioning concepts 
