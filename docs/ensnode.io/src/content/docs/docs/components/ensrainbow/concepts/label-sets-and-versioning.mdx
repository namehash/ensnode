...
A **[label set](/docs/components/ensrainbow/concepts/glossary#label-set)** is analogous to a _dataset snapshot_. Every time upstream data grows (e.g. additional rainbow records created), we create a new **[label set version](/docs/components/ensrainbow/concepts/glossary#label-set-version)** so that:
...
- **[Glossary](/docs/components/ensrainbow/concepts/glossary)** - Key terminology including [label set](/docs/components/ensrainbow/concepts/glossary#label-set) and [label set version](/docs/components/ensrainbow/concepts/glossary#label-set-version) terms
- **[TypeScript Interfaces](/docs/components/ensrainbow/concepts/typescript-interfaces)** - Type definitions for ENSRainbow's server and client
- **[Data Model](/docs/components/ensrainbow/concepts/data-model)** - How versions are stored in the database 
