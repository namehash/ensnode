...
While we aim for high availability, if you need guaranteed uptime or want to keep your requests private, we recommend [deploying your own instance](/docs/components/ensrainbow/deploying/).
:::
