...
For TypeScript projects, the [ENSDb SDK](/docs/components/ensdb/concepts/glossary#ensdb-sdk) provides a convenient and efficient way to interact with your ENSDb instance.
