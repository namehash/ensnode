...
Depending on the activated [ENSNode plugins](/docs/integrate/integration-options/ensnode-plugins) for your [ENSDb Writer](/docs/services/ensdb/concepts/glossary#ensdb-writer) instance, data indexed in ENSDb may include:
