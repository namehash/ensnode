...
<Aside type="tip" title="Coming soon: ENSDb snapshots & CLI">
We're building **portable ENSDb snapshots** and a **`ensdb-cli`** for bootstrapping fresh instances in minutes, diffing snapshots for release reviews, and operating ENSNode like a database. See the [ENSDb snapshots & CLI teaser](/docs/integrate/ensdb-snapshots-and-cli) for the full value-prop preview.
</Aside>
