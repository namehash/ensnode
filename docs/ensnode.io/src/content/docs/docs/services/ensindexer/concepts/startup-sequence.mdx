...
When the Ponder app lifecycle reaches the step for "Execute migrations for the `prod_0` ENSIndexer Schema", Ponder will execute any pending migrations for the `prod_0` ENSDb Writer Schema.
