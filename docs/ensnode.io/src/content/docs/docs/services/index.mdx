...
Each ENSNode instance is composed of **a set of services**. Each service has a clear role in indexing, storing the onchain state of ENS, APIs, name healing, admin operations, or reactive event delivery.
...
<CardGrid>
  ...
  <LinkCard title="ENSEngine (planned)" href="/docs/services/ensengine" description="Coming soon - watches ENSDb for changes and delivers ENS-aware webhooks." />
</CardGrid>
