...
- **Co-location with the [ENSIndexer](/docs/services/ensindexer) instance**: to minimize requests latency and maximize throughput.
...
<LinkCard
  title="Learn about ENSNode massive scalability"
