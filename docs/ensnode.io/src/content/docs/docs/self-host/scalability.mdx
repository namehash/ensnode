...
- **One ENSDb primary instance** → replicates asynchronously to `N` replicas
- **Multiple ENSApi instances** → each connected to the ENSDb primary instance or any ENSDb replica (often load-balanced across replicas)
