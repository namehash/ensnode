...
<table>
    ...
    <tr>
        ...
        <td class="not-content">
            <a class="block w-fit" target="_blank" rel="noopener noreferrer" href="https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.alpha.ensnode.io">
    ...
    <tr>
        <td>Purpose</td>
        <td>
            Demonstration of ENSNode's multichain ENS indexing capability. Provides a superset of the data indexed by the ENS Subgraph. Indexes Resolver record values in preparation for ENS Protocol Acceleration.
        </td>
    </tr>
    </tbody>
</table>
...
<table>
    ...
    <tr>
        <td style={{verticalAlign: "middle"}}>ENSAdmin</td>
        <td class="not-content">
            <a class="block w-fit" target="_blank" rel="noopener noreferrer" href="https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.mainnet.ensnode.io">
                <button class="open-in-ensadmin flex flex-row flex-nowrap justify-start items-center gap-1 min-[400px]:gap-2 transition-all button-as-child bg-[var(--sl-color-accent)]
                hover:bg-[var(--sl-color-accent-high)] text-[var(--sl-color-black)] text-xs min-[400px]:text-base font-medium pl-1 pr-2 py-1 min-[400px]:pl-2 min-[400px]:pr-3 min-[400px]:py-2 rounded-lg">
                    <svg
                        width="26"
...
<table>
    ...
    <tr>
        <td style={{verticalAlign: "middle"}}>ENSAdmin</td>
        <td class="not-content">
            <a class="block w-fit" target="_blank" rel="noopener noreferrer" href="https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.sepolia.ensnode.io">
                <button class="open-in-ensadmin flex flex-row flex-nowrap justify-start items-center gap-1 min-[400px]:gap-2 transition-all button-as-child bg-[var(--sl-color-accent)]
                hover:bg-[var(--sl-color-accent-high)] text-[var(--sl-color-black)] text-xs min-[400px]:text-base font-medium pl-1 pr-2 py-1 min-[400px]:pl-2 min-[400px]:pr-3 min-[400px]:py-2 rounded-lg">
                    <svg
                        width="26"
...
<table>
    ...
    <tr>
        <td style={{verticalAlign: "middle"}}>ENSAdmin</td>
        <td class="not-content">
            <a class="block w-fit" target="_blank" rel="noopener noreferrer" href="https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.holesky.ensnode.io">
                <button class="open-in-ensadmin flex flex-row flex-nowrap justify-start items-center gap-1 min-[400px]:gap-2 transition-all button-as-child bg-[var(--sl-color-accent)]
                hover:bg-[var(--sl-color-accent-high)] text-[var(--sl-color-black)] text-xs min-[400px]:text-base font-medium pl-1 pr-2 py-1 min-[400px]:pl-2 min-[400px]:pr-3 min-[400px]:py-2 rounded-lg">
                    <svg
                        width="26"
