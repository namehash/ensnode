    ...
    <tr>
        ...
        <td class="not-content">
            <SecondaryButtonIsland
                client:load
                text="Open in ENSAdmin"
                size="small"
                linkData={({
                    link: "https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.alpha.ensnode.io",
                    target: "_blank"
                })}/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="not-content">
            <SecondaryButtonIsland
                ...
                size="small"
                linkData={({
                    link: "https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.sepolia.ensnode.io",
                    target: "_blank"
                })}/>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td class="not-content">
            <SecondaryButtonIsland
                ...
                size="small"
                linkData={({
                    link: "https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.holesky.ensnode.io",
                    target: "_blank"
                })}/>
        </td>
    </tr>
