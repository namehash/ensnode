...
<table style={{marginTop: "0"}}>
    ...
    <tr>
        ...
        <td style={{marginTop: "17px"}} class="flex flex-row justify-start items-center">
            <a href="https://api.alpha.ensnode.io">https://api.alpha.ensnode.io</a>
            <a class="not-content block w-fit pl-4" target="_blank" rel="noopener noreferrer" href="https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.alpha.ensnode.io">
...
<table style={{marginTop: "0"}}>
    ...
    <tr>
        ...
        <td style={{marginTop: "18px"}} class="flex flex-row justify-start items-center">
            <a href="https://api.mainnet.ensnode.io">https://api.mainnet.ensnode.io</a>
            <a class="not-content block w-fit pl-4" target="_blank" rel="noopener noreferrer" href="https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.mainnet.ensnode.io">
                <button class="open-in-ensadmin flex flex-row flex-nowrap justify-start items-center gap-1 min-[400px]:gap-2 transition-all button-as-child bg-[var(--sl-color-accent)]
                hover:bg-[var(--sl-color-accent-high)] text-[var(--sl-color-black)] text-xs min-[400px]:text-base font-medium pl-1 pr-2 py-1 min-[400px]:pl-2 min-[400px]:pr-3 min-[400px]:py-2 rounded-lg">
                    <svg
                        width="26"
...
<table style={{marginTop: "0"}}>
    ...
    <tr>
        ...
        <td style={{marginTop: "18px"}} class="flex flex-row justify-start items-center">
            ...
            <a class="not-content block w-fit pl-4" target="_blank" rel="noopener noreferrer" href="https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.sepolia.ensnode.io">
                <button class="open-in-ensadmin flex flex-row flex-nowrap justify-start items-center gap-1 min-[400px]:gap-2 transition-all button-as-child bg-[var(--sl-color-accent)]
                hover:bg-[var(--sl-color-accent-high)] text-[var(--sl-color-black)] text-xs min-[400px]:text-base font-medium pl-1 pr-2 py-1 min-[400px]:pl-2 min-[400px]:pr-3 min-[400px]:py-2 rounded-lg">
                    <svg
                        width="26"
...
<table style={{marginTop: "0"}}>
    ...
    <tr>
        ...
        <td style={{marginTop: "18px"}} class="flex flex-row justify-start items-center">
            ...
            <a class="not-content block w-fit pl-4" target="_blank" rel="noopener noreferrer" href="https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.holesky.ensnode.io">
                <button class="open-in-ensadmin flex flex-row flex-nowrap justify-start items-center gap-1 min-[400px]:gap-2 transition-all button-as-child bg-[var(--sl-color-accent)]
                hover:bg-[var(--sl-color-accent-high)] text-[var(--sl-color-black)] text-xs min-[400px]:text-base font-medium pl-1 pr-2 py-1 min-[400px]:pl-2 min-[400px]:pr-3 min-[400px]:py-2 rounded-lg">
                    <svg
                        width="26"
