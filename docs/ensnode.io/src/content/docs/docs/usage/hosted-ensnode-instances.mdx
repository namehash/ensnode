...
sidebar:
  ...
  order: 1
---
import SecondaryButtonIsland from "../../../../components/atoms/SecondaryButtonIsland.js"
...
<table>
    ...
    <tr>
        <td>ENSAdmin</td>
        <td class="not-content"><SecondaryButtonIsland text="Open in ENSAdmin" size="small" linkData={{link: "https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.alpha.ensnode.io", target: "_blank"}}/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="not-content">
            <SecondaryButtonIsland text="Open in ENSAdmin" size="small" linkData={{link: "https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.mainnet.ensnode.io", target: "_blank"}}/>
        </td>
    </tr>
    <tr>
        <td>Active Plugins</td>
    ...
    <tr>
        <td>ENSAdmin</td>
        <td class="not-content">
            <SecondaryButtonIsland text="Open in ENSAdmin" size="small" linkData={{link: "https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.sepolia.ensnode.io", target: "_blank"}}/>
        </td>
    </tr>
    <tr>
        <td>Active Plugins</td>
    ...
    <tr>
        <td>ENSAdmin</td>
        <td class="not-content">
            <SecondaryButtonIsland text="Open in ENSAdmin" size="small" linkData={{link: "https://admin.ensnode.io/status?ensnode=https%3A%2F%2Fapi.holesky.ensnode.io", target: "_blank"}}/>
        </td>
    </tr>
    <tr>
        <td>Active Plugins</td>
