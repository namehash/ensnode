...
<HostedEnsNodeInstances
    ...
    connectWithENSAdminURL="https://admin.ensnode.io/connect?ensnode=https%3A%2F%2Fapi.alpha.ensnode.io"
    namespace="mainnet"
...
<HostedEnsNodeInstances
    ...
    connectWithENSAdminURL="https://admin.ensnode.io/connect?ensnode=https%3A%2F%2Fapi.alpha-sepolia.ensnode.io"
    namespace="sepolia"
...
<HostedEnsNodeInstances
    ...
    connectWithENSAdminURL="https://admin.ensnode.io/connect?ensnode=https%3A%2F%2Fapi.mainnet.ensnode.io"
    namespace="mainnet"
    plugins="subgraph"
...
<HostedEnsNodeInstances
    ...
    connectWithENSAdminURL="https://admin.ensnode.io/connect?ensnode=https%3A%2F%2Fapi.sepolia.ensnode.io"
    namespace="sepolia"
    plugins="subgraph"
...
<HostedEnsNodeInstances
    ...
    connectWithENSAdminURL="https://admin.ensnode.io/connect?ensnode=https%3A%2F%2Fapi.holesky.ensnode.io"
    namespace="holesky"
    plugins="subgraph"
