...
The foundation for how developers and their AI agents reach for ENS is [`ensskills`](/docs/integrate/integration-options/ensskills), versioned agent skills that teach your AI assistant the ENS Omnigraph and drive [`enscli`](/docs/integrate/integration-options/enscli)—an agent- and human-friendly CLI—on your behalf.
