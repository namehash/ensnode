...
<LinkCard
  title="Fix ENS integrations from breaking"
  href="/docs/integrate/why-ensnode/keep-ens-working"
  description="See the apps that break when ENSv2 launches, and how ENSNode keeps them working."
/>
<LinkCard
...
## ENSNode Subgraph compatability

ENSNode maintains a verified Subgraph-compatible API for migrating existing integrations, but it is **not** the path forward for ENSv2.
