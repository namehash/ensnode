...
The [ENS Omnigraph API](/docs/integrate/omnigraph) is built to close every gap on this page: one unified, typed API over ENSv1 and ENSv2, multichain by default, with [ENS Protocol Acceleration](/docs/services/ensapi#ens-protocol-acceleration) for resolution.
:::
...
:::tip
The [Omnigraph API](/docs/integrate/omnigraph) provides a unified datamodel across ENSv1 and ENSv2 resources: write your query once and your platform automatically understands both protocol versions without any extra work on your end.
:::
...
<LinkCard
  ...
  description="ENSv2-ready unified GraphQL API over both ENSv1 and ENSv2."
  href="/docs/integrate/omnigraph"
/>

<LinkCard
  title="ENS Unigraph SQL"
  description="ENSv2-ready unified datamodel over both ENSv1 and ENSv2."
