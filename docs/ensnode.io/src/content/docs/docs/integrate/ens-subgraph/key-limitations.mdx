...
The [Omnigraph API](/docs/integrate/omnigraph) already heals **~94%** of these labels with [ENSRainbow](/docs/services/ensrainbow), compared to roughly **~11%** with the label set bundled in the traditional ENS Subgraph. ENSRainbow has healed **259,053,605** unknown labels so far (as reported on [ensrainbow.io](https://ensrainbow.io)), and coverage is climbing toward a **99%** target.
:::
