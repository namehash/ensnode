...
<Aside type="caution" title="Unigraph plugin hard dependency">
  ...
  Schema**, and the other ENSNode Plugins (Registrars, Subgraph, tokenscope) are documented in
...
- `__canonical_name_prefix` (GIN trigram for left-anchored `LIKE 'vit%'` and substring search)
