...
import UnigraphStaticExample from "@components/molecules/UnigraphStaticExample.astro";
...
export const sqlExampleSnippet = `SELECT * FROM ensindexer_0.domains\nWHERE canonical_name = 'vitalik.eth';`
...
<UnigraphStaticExample
 sql={{
  ...
  result: unigraphSqlResultJson,
 }}
 ensdbsdk={{
  codeSnippet: tsExampleSnippet,
  result: ensDbSdkResultJson,
 }}>
  <EnsIndexerSchemaIntro ensIndexerSchemaName="ensindexer_0" slot="sql-tab-note"/>
 </UnigraphStaticExample>
