...
- **Accelerated self-hosting:** [ensdb-cli & snapshots](/docs/integrate/ensdb-cli) — bootstrap a fresh, nearly-current ENSDb in minutes instead of waiting days and spending big on RPC credits to complete your own full historical backfill.
