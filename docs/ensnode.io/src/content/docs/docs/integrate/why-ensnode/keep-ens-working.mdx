...
<UpgradeToOmnigraphRequiredTable>
  ...
  <ENSSubgraphDependentApp toENSNodeSubgraphCompatibleEndpoint={false} toOmnigraphAPI={false}>
  <a href="https://daostar.org/" target="_blank" rel="noopener noreferrer" class="omnigraph-required-table-content"><strong>DAOStar</strong></a> — by <a href="http://Metagov.org" target="_blank" rel="noopener noreferrer" class="omnigraph-required-table-content">Metagov</a>.
  </ENSSubgraphDependentApp>
...
<UpgradeToOmnigraphRequiredTable>
  ...
  <ENSSubgraphDependentApp toENSNodeSubgraphCompatibleEndpoint={false} toOmnigraphAPI={false}>
  <a href="http://web3.bio/" target="_blank" rel="noopener noreferrer" class="omnigraph-required-table-content"><strong>Web3.bio</strong></a> — builds on <a href="https://next.id/" target="_blank" rel="noopener noreferrer" class="omnigraph-required-table-content">Next.ID</a>.
  </ENSSubgraphDependentApp>
