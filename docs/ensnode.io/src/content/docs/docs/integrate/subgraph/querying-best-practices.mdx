...
For more details, see [Subgraph Compatibility](/docs/integrate/subgraph/what-is-the-ens-subgraph#self-hosted-ensnode-instance-configuration-for-ens-subgraph-compatibility).
:::
