...
- Driving an AI agent instead of writing code? Every instance also serves this same API over the [Model Context Protocol](https://modelcontextprotocol.io/) at `/api/mcp` — see [ENS Omnigraph MCP](/docs/integrate/integration-options/omnigraph-mcp).
