...
<Code
  lang="bash"
  code={`# list all skills in ensskills
npx skills add https://github.com/namehash/ensnode/tree/v${snapshot.sdkVersion}/packages/ensskills/skills --list
  `}
/>

<Code
  lang="bash"
  code={`# add just the skill you want
npx skills add https://github.com/namehash/ensnode/tree/v${snapshot.sdkVersion}/packages/ensskills/skills --skill omnigraph
  `}
/>
