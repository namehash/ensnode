...
description: Preview of ERC-8004 AI agent discovery in the ENS Omnigraph API — find agents associated with an ENS name, look up the names behind an agent, and read agent service profiles, gated behind a future ERC-8004 ENSNode plugin.
---
...
AI agent discovery is an new opportunity where ENS names can act as the human-readable, portable
