...
<LinkCard
  title="ENSEngine overview (planned)"
  description="The planned ENSNode service that powers the capability above: watches ENSDb for changes and routes ENS-aware events to your sinks. Code name is temporary."
