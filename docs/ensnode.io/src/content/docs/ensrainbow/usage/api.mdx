...
- **`label_set_version`** (optional): Specifies the highest label set version to accept. Only labels from sets less than or equal to this value will be returned. Must be provided together with `label_set_id`.
...
- `label_set_id`: The label set id of the loaded database
- `highest_label_set_version`: The highest label set version available in the database
