...
*   **Flexible Data Management:** Uses a label set id and label set version system for organizing different datasets and incremental updates.
...
ENSRainbow is designed to be self-hosted and deployed by anyone and everyone. The Docker image is lightweight and downloads the required database at runtime based on your configuration.
