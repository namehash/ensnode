...
*   **Extensible and Decentralized Data Management:** Uses a label set id and label set version system for enabling any number of different label sets and for each label set to support incremental updates across time.
...
ENSRainbow is designed to be self-hosted and deployed by anyone and everyone. The Docker image is lightweight and downloads the requested database at runtime based on your configuration.
