...
*   **Extensible and Decentralized Data Management:** Uses a label set id and label set version system for enabling any number of different label sets and for each label set to support incremental updates.
