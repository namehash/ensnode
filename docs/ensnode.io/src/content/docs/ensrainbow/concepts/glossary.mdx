...
| **Label Set ID** | String (1-50 chars) consisting of lowercase letters & dashes that names a label set. | `subgraph`, `discovery-a` |
| **Label Set Version** | Non-negative integer that monotonically increases when the underlying data source is re-exported. Enables deterministic healing across time. | `0`, `1`, `2` |
