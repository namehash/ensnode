...
Instead of building the Docker images yourself, you can also 
download the pre-built images directly from the GitHub Container 
Registry:
...
docker run -p 3223:3223 ghcr.io/namehash/ensnode/
ensrainbow-test:latest
```

This approach is faster and more convenient as it doesn't require 
