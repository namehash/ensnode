...
docker build -f apps/ensrainbow/Dockerfile.data \
  ...
  -t ghcr.io/namehash/ensnode/ensrainbow-test-data .
...
docker build -f apps/ensrainbow/Dockerfile \
  ...
  -t ghcr.io/namehash/ensnode/ensrainbow-test .
...
docker pull ghcr.io/namehash/ensnode/ensrainbow-test

# Run the ENSRainbow container with the pulled image
docker run -p 3223:3223 ghcr.io/namehash/ensnode/ensrainbow-test
```
