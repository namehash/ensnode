...
The [ENSDb standard](/ensdb/concepts/glossary#ensdb-standard) is implementation-agnostic, so you have options: implement your own [ENSDb Writer](/ensdb/concepts/glossary#ensdb-writer) or [ENSDb Reader](/ensdb/concepts/glossary#ensdb-reader) in any language, or use the initial reference implementations provided by ENSNode — [ENSIndexer](/ensindexer/) as an ENSDb Writer and [ENSApi](/ensapi/) as an ENSDb Reader.
