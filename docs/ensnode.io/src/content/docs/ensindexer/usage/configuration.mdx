...
**ENSIndexer requires private RPC endpoints to function.** Public (rate limited) RPC endpoints will NOT provide acceptable performance.

You must configure private (paid) RPC services from providers like Alchemy, Infura, or QuickNode or host your own RPC service that can handle high-volume requests.
:::
