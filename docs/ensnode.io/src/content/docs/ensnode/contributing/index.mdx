...
Review the docs inside `.env.local` file for configuration instructions, or see the `.env.local.example` on GitHub.

<LinkCard
  title="View .env.local.example on GitHub"
  description="See the example environment configuration file"
  href="https://github.com/namehash/ensnode/blob/main/apps/ensnode/.env.local.example"
  target="_blank"
/>
