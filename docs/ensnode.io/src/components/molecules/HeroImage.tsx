...
export default function HeroImage() {
  return (
    <div className="videoContainer relative flex flex-col justify-center items-center w-screen h-[60%] sm:h-auto sm:w-4/5 xl:w-[calc(100vw-15%)] max-w-[1216px] max-h-[608px] z-10">
