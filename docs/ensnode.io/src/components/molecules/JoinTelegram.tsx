...
export default function JoinTelegram() {
  return (
      <div
          className="bg-telegram_bg max-w-[1216px] w-full h-fit flex flex-col sm:flex-row justify-center items-center flex-nowrap gap-10 sm:gap-5 sm:pl-20 sm:pr-5 pt-10 sm:pt-0 rounded-[20px] overflow-hidden">
          <div
              className="w-4/5 h-fit flex flex-col flex-nowrap items-center sm:items-start justify-center gap-5 sm:py-5">
              <Balancer
                  as="h2"
          ...
          <img
              className="hidden sm:flex w-auto h-[280px] shrink-0 object-contain bg-no-repeat"
              src={TelegramBanner.src}
              alt="Telegram Banner"
          />
          <img
              className="sm:hidden flex w-fit h-full shrink-0 object-contain bg-no-repeat"
