...
export const LineaLogo = (props: React.SVGProps<SVGSVGElement>) => (
    <svg width="280" height="280" viewBox="0 0 280 280" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <g clipPath="url(#clip0_663_119364)">
            ...
            <mask id="mask0_663_119364" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="100" y="99" width="79"
                  height="82">
                <path d="M178.407 99.5103H100.766V180.492H178.407V99.5103Z" fill="white"/>
            </mask>
            <g mask="url(#mask0_663_119364)">
                <path d="M165.247 180.492H100.766V112.651H115.519V167.344H165.247V180.485V180.492Z" fill="#121212"/>
                <path
