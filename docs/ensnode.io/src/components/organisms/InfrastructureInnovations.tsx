...
} from "../molecules/InnovationSection.tsx";
        ...
        <>
            <Fragment key="Infrastructure-Innovations-Header">
                <div className="w-full h-fit flex flex-col justify-center items-center gap-5 pt-[120px]">
                    <h1 className="max-w-[720px] text-center text-black text-4xl leading-10 font-bold">ENSv2
                        Infrastructure Innovations</h1>
                    <p className="max-w-[720px] text-center text-gray-500 text-lg leading-7 font-normal">Lorem ipsum
...
const innovationSections: InnovationSectionProps[] = [
    {
        ...
        sectionDescription: (
            <>
                Indexed ENS data is vital for the upcoming launch of ENSv2 and Namechain. Existing ENS indexed data
                providers (the ENS Subgraph) are fundamentally unsuitable for ENSv2 and a replacement is critically
                required for many of ENS’s most important apps, including the official ENS Manager App among many
                others.
            </>
        ),
    ...
    },
    {
        ...
        sectionDescription: (
            <>
                Our infrastructure under development removes a strict dependency on many centralized offchain gateway
                servers whose downtime would otherwise shut down impacted multichain ENS names that are key to the
                future of ENSv2 and Namechain, such as subnames of base.eth, linea.eth, or tokenized DNS names such as
                .box names or 3DNS names.
            </>
        ),
    ...
    },
    {
        ...
        sectionDescription: (
            <>
                We are engineering radically accelerated resolution of most ENS queries. ENSNode’s architecture unlocks
                near-instant bulk resolution of live ENS records, including name resolution configurations that span
