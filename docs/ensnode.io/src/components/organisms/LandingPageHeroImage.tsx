  ...
  return (
    <section className="box-border not-content h-screen w-screen flex flex-col sm:flex-row flex-nowrap justify-center items-center gap-5 bg-hero_bg_sm sm:bg-hero_bg px-5 sm:px-0">
      <div className="relative w-screen sm:w-2/3 h-full overflow-hidden">
        <div className="absolute z-10 w-full h-full flex flex-col sm:flex-row flex-nowrap justify-between items-center sm:pl-10">
      ...
      <div className="relative z-10 flex flex-col flex-nowrap justify-center items-center gap-8 sm:justify-evenly sm:gap-80 sm:items-end w-full sm:w-1/3 h-1/2 sm:h-full py-5 sm:py-0">
        <img
          className="sm:absolute sm:top-20 sm:right-10 w-1/3 sm:w-[60%]"
          src={ensnode_with_name.src}
          alt="ENSNode"
        />
        <div className="sm:absolute sm:bottom-10 sm:right-10 flex flex-col flex-nowrap justify-start items-center sm:items-end gap-4">
          ...
          <div className="flex flex-row flex-nowrap justify-end items-center gap-8">
            ...
            >
              <button className="transition-all duration-200 hover:shadow-hero_button_shd flex flex-row flex-nowrap justify-center items-center gap-2 text-white border-2 border-white rounded-lg px-4 py-2">
                <GithubIcon className="w-10 h-auto" /> GitHub
              </button>
            </a>
