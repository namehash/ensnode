...
export default function Hero() {
    return (
        <section
            className="box-border not-content h-screen w-screen flex flex-col flex-nowrap justify-end sm:justify-center items-center gap-8 sm:gap-4 px-5 sm:px-0 sm:pt-[72px] super_wide_hero:pt-0 pb-5 bg-hero_bg_sm sm:bg-hero_bg">
            <div
