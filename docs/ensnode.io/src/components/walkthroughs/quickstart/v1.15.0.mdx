...
import GraphqlStaticQueryExampleBlock from "@components/organisms/GraphqlStaticQueryExampleBlock.astro";
...
<GraphqlStaticQueryExampleBlock id="domains-by-address" hideDescription hideBackToExamples />
