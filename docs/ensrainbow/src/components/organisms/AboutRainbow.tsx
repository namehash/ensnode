...
export default function AboutRainbow(props: AboutRainbowProps) {
  return (
    <section className="box-border h-fit w-full flex flex-col xl:flex-row items-center justify-center gap-5 sm:gap-0 py-[60px] px-5 bg-white md:py-20 xl:px-28 xl:py-[120px]">
