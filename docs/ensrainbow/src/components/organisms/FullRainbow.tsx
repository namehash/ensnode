...
export default function FullRainbow() {
  ...
  return (
    <section className="box-border w-full h-fit xl:h-full xl:max-h-screen flex flex-col xl:flex-row items-center justify-center gap-8 xl:gap-[120px] py-[60px] px-5 bg-[#FEFEFF] md:py-20 lg:px-28 lg:py-[120px]">
      <div className="relative flex flex-row justify-center items-center w-full max-w-2xl xl:w-[60%] rounded-none bg-origin-border flex-shrink-0 box-border">
        {barChart()}
      </div>
