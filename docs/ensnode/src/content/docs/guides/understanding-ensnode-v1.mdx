...
ENSNode is a modern ENS indexer built on [Ponder](https://ponder.sh/) that aims to provide a more efficient, flexible, and maintainable alternative to the ENS Subgraph. ENSNode also introduces multichain indexing while maintaining backwards compatibility with existing ENS Subgraph APIs.
