...
- **503 responses for API routes during bootstrap**: `/v1/heal`, `/v1/labels/count`, `/v1/config`, and `/v1/version` return a structured `ServiceUnavailableError` (`errorCode: 503`) until the database is ready.
