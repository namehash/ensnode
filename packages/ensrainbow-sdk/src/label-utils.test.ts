...
describe("labelHashToBytes", () => {
  ...
  it("should throw error when labelhash begins with 1x", () => {
    ...
    // Testing invalid input
    expect(() => labelHashToBytes(onePrefix as Labelhash)).toThrow(
      "Labelhash must be 0x-prefixed"
    );
  });
  ...
  it("should throw error when labelhash contains mixed case characters", () => {
    const mixedCase =
      "0x0123456789aBcDeF0123456789abcdef0123456789abcdef0123456789abcdef" as Labelhash;
    expect(() => labelHashToBytes(mixedCase)).toThrow(
      "Labelhash must be in lowercase"
    );
  });
  ...
  it("should throw error when hash is 63 hex digits", () => {
    const hash63 =
      "0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcde" as Labelhash;
  ...
  it("should throw error when labelhash is 62 hex digits", () => {
    const hash62 =
      "0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcd" as Labelhash;
