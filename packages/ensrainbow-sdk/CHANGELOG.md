...
- [#1960](https://github.com/namehash/ensnode/pull/1960) [`1eccf18`](https://github.com/namehash/ensnode/commit/1eccf18d78f48b63e02a8e11e5916ac2f365ea32) Thanks [@djstrong](https://github.com/djstrong)! - Remove deprecated ENSRainbow `version()` client method and `Version*` types (the `/v1/version` endpoint has been removed in favor of `/v1/config`).
