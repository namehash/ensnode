...
export const nameSold = onchainTable(
    ...
    (t) => ({
         ...
         * Can either be ETH, USDC, WETH or DAI
         */
        ...
        /**
         * Order hashes are generated by the Seaport protocol which basically takes all the order components (considerations, offers etc)
         * to create a unique hash, which is used to track and reference the order.
         */
        ...
        /**
         * Unix time stamp of when the name was sold (block timestamp)
         */
