...
import {
  chainStatusesBackfillMixed,
  chainStatusesCompleted,
  chainStatusesFollowingMixed,
  chainStatusesQueued,
} from "./chain-indexing-status-snapshot.mocks";
import {
...
describe("Omnichain Indexing Status", () => {
  describe("getOmnichainIndexingStatus", () => {
    ...
    it("can correctly derive 'unstarted' status if all chains are in 'queued' status", () => {
      // arrange
      const chainStatuses = chainStatusesQueued;
    ...
    it("can correctly derive 'backfill' status if all chains are either 'queued', 'backfill' or 'completed'", () => {
      // arrange
      const chainStatuses = chainStatusesBackfillMixed;
