...
import type { UsePrimaryNamesParameters, WithEnsApiProviderOptions } from "../types";
 ...
 * ```
 */
export function usePrimaryNames(parameters: UsePrimaryNamesParameters & WithEnsApiProviderOptions) {
